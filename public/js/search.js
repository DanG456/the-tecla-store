...
class Products {
    ...
    crearProductos = () => {
        for (let index = 0; index < 19; index++){
            ...
            titleSearch.textContent = `${auxName}`

            //Description
            let descriptionSearch = document.getElementById("searchDescription");
            descriptionSearch.textContent = `Se han encontrado los siguientes productos con la búsqueda "${auxName}"`
